...
| Backlog modernization 2026-06-03 | Добавлены skip-safe Runtime UI table checks, optional browser external-embedding smoke, write-mode `expectedSpecHash` conflict coverage и runbook/SLO baseline. |
