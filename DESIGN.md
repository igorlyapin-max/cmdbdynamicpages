...
- A pending D2 proposal never mutates the deterministic diagram settings. Proposal mappings are reviewed first; common Diagram settings are editable after deterministic Apply.
...
- After deterministic apply, require a successful preview before save; publication remains a separate explicit action.
